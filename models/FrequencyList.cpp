      ...
      switch (column)
        ...
        case region_column:
          switch (role)
            ...
            case Qt::TextAlignmentRole:
              item = static_cast<int> (Qt::AlignHCenter | Qt::AlignVCenter);
              break;
            }
          break;
        ...
        case frequency_column:
          switch (role)
            ...
            case Qt::TextAlignmentRole:
              item = static_cast<int> (Qt::AlignRight | Qt::AlignVCenter);
              break;
            }
          break;
            ...
            switch (role)
              {
                ...
                case Qt::TextAlignmentRole:
                  item = static_cast<int> (Qt::AlignLeft | Qt::AlignVCenter);
                break;
              }
            break;
