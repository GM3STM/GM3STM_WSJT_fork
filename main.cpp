...
int main(int argc, char *argv[])
{
  ...
  // WSJT-X has its own explicit dark stylesheet option. Keep Qt's
  // platform theme light unless that option is enabled.
  ...
  try
    {
      ...
      auto writeable_data_dir = QDir {QStandardPaths::writableLocation (QStandardPaths::AppDataLocation)};
