                  ...
                  if (!memcmp (&wave_desc.id_, "fmt ", 4))
                    {
                      ...
                      switch (bits_per_sample)
                        ...
                        case 32: format_.setSampleFormat (QAudioFormat::Int32); break;
...
{
  data_size_ = -1;
  if (QAudioFormat::UInt8 != format.sampleFormat ()
      && QAudioFormat::Int16 != format.sampleFormat ()
      && QAudioFormat::Int32 != format.sampleFormat ()) return false;
...
bool BWFFile::is_big_endian () const {return m_->big_endian_;}
